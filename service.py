...
if __name__ == "__main__":
    ...
    parser = OptionParser(version=__version__, usage=__doc__, description=auth.__doc__)
    parser.add_option("-g", "--get", action="append", help="get paste identified by ID")
    parser.add_option(
        "-d", "--delete", action="append", help="delete paste identified by ID"
    )
    parser.add_option(
        "-i",
        "--id",
